...
\centering
\footnotesize
\caption{Supplementary screening flow for the fixed evidence appendix \texttt{VLA-Attack-ER-v2026-06-16}. Counts describe the literature screening workflow; it was not prospectively registered.}
...
Included entries in fixed appendix & 85 & Core evidence (30) plus contextual references (55). \\
\bottomrule
\end{tabularx}
\end{table}
