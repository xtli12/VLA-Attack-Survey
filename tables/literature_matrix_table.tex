...
\centering
\scriptsize
\caption{Representative mechanism synthesis by literature role. Core rows summarize attack mechanisms; contextual rows explain substrates or evaluation context but are not treated as direct VLA attack results. D: digital; S: simulation; HIL: hardware-in-the-loop; P: physical robot/world; PR: peer-reviewed; PP: preprint or non-archival version.}
...
\toprule
\textbf{Role} & \textbf{Representative work} & \textbf{Status} & \textbf{Validation} & \textbf{What the evidence supports} \\
\midrule
